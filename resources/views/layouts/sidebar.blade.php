<aside class="left-sidebar bg-sidebar">
    <div id="sidebar" class="sidebar sidebar-with-footer">
        ...
        UI Elements
                ...
                <li
                    class="has-sub {{ Request::is('kelas/*') || Request::is('jurusan/*') || Request::is('tahun-magang/*') ? 'active expand' : '' }}">
                    ...
                    <ul class="collapse {{ Request::is('kelas/*') || Request::is('jurusan/*') || Request::is('tahun-magang/*') ? 'show' : '' }}"
