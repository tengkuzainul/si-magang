    ...
    <section class="section">
        ...
        <div class="section-body">
            <div class="d-flex justify-content-between align-items-center">
                <h2 class="section-title">Edit Tahun Magang</h2>
            </div>
                ...
                <div class="col-12">
                    <div class="card shadow">
                        <div class="card-header">
                            <h4>Form Edit Tahun Magang</h4>
                        </div>
                        <form action="{{ route('tahun-magang.update', $magang->id) }}" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="kode_magang" id="kode_magang"
                                                    value="{{ old('kode_magang', $magang->kd_tahun_magang) }}"
                                                    class="form-control @error('kode_magang') is-invalid @enderror"
                                                    placeholder="(ex:20241)" aria-label="Kode Magang">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="string" name="tahun_ajaran_magang" id="tahun_ajaran_magang"
                                                    value="{{ old('tahun_ajaran_magang', $magang->tahun_magang) }}"
