<head>
    ...
    <title>SISMA SMK 6 PEKANBARU &mdash; {{ $title }}</title>
    ...
    <link rel="stylesheet" href="{{ asset('assets/dashboard/modules/select2/dist/css/select2.min.cs') }}s">
    <link rel="stylesheet" href="{{ asset('assets/dashboard/modules/jquery-selectric/selectric.css') }}">
    <link rel="stylesheet"
        href="{{ asset('assets/dashboard/modules/bootstrap-timepicker/css/bootstrap-timepicker.min.c') }}ss">
    <link rel="stylesheet"
